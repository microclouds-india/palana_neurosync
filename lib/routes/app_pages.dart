...
class AppPages {
  ...
  static final routes = [
    ...
    //     binding: HomeBinding()),
    // GetPage(
    //     name: Routes.PACKAGEDETAILSPAGE,
    //     page: () => PackageDetailsPage(),
    //     binding: HomeBinding()),
    // GetPage(
    //     name: Routes.ALLPACKAGESPAGE,
    //     page: () => AllPackagesPge(),
    //     binding: HomeBinding()),
    GetPage(name: Routes.ABOUTUSPAGE, page: () => AboutUsPage()),
    GetPage(name: Routes.DOWNLOADSCREEN, page: () => DownloadsPage()),
    // GetPage(name: Routes.NOINTERNET, page: () => NoInternetScreen()),
    GetPage(
        name: Routes.PLAYAUDIOPAGE,
        page: () => PlayAudioPage(),
        binding: HomeBinding()),
    GetPage(name: Routes.INITIALROOT, page: () => FirstSplashScreen()),
  ];
